	  				...
	  				<div class="col-md-12">
	  					<div class="col-md-12 panel-info">
			  				<div class="content-box-header panel-heading">
					            <div class="panel-title">¡Contrato añadido!</div>        
								</div>
			  				<div class="content-box-large box-with-header">
<?php
	echo "<p><button class=btn btn-success btn-lg><a href=presupuesto.php?expediente=$expediente&id_contrato=$id_contrato>Añadir un presupuesto para este contrato</a></button></p>";
	mysqli_close($conn);
